...
public class Fractal : MonoBehaviour {
	...
	private void Initialize(Fractal parent, int childIndex) {
		...
		maxDepth = parent.maxDepth; // YOUR CHANGE HERE
		maxRotationSpeed = parent.maxRotationSpeed; // YOUR CHANGE HERE
		depth = parent.depth + 1; // YOUR CHANGE HERE
		transform.parent = parent.transform; // YOUR CHANGE HERE
        ...
        transform.localScale = new Vector3(childScale, childScale, childScale); // YOUR CHANGE HERE
		transform.localPosition = 0.75f * childDirections[childIndex]; // YOUR CHANGE HERE
		transform.localRotation = childOrientations[childIndex]; // YOUR CHANGE HERE
	}
	...
	private IEnumerator CreateChildren () {
		...
		for (int i = 0; i < childDirections.Length; i++) {
            ...
            child.AddComponent<Fractal>().Initialize(gameObject.GetComponent<Fractal>(), i);
            //Initialize(gameObject.GetComponent<Fractal>(), i);
...
/*
	private static Mesh[] meshlabels = {
		Mesh.Cube,
		Mesh.Cube,
		Mesh.Cube,
		Mesh.Cube,
